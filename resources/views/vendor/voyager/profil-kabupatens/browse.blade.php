                        ...
                        <div class="table-responsive">
                            <table id="dataTable" class="table table-hover">
                                ...
                                @if(Auth::user()->hasRole('kab'))
                                    @foreach($dataTypeContent->where('kab_kota_id', Auth::user()->id) as $data)
                                    <tr>
                                        @if($showCheckboxColumn)
                                            <td>
                                            ...
                                            <td>
                                                ...
                                                @elseif($row->type == 'text')
                                                    ...
                                                    @elseif($row->field == 'proyek_kerjasama')
                                                        @php
                                                            $proyek_kerjasamas = json_decode($data->proyek_kerjasama);
                                            ...
                                            @foreach($dataType->browseRows as $row)
                                                ...
                                                <td>
                                                    ...
                                                    @elseif($row->type == 'text')
                                                        ...
                                                        @elseif($row->field == 'proyek_kerjasama')
                                                            ...
                                                            @foreach((array)$proyek_kerjasamas as $proyek_kerjasama)
                                                                ...
                                                                @for($i=0;$i<count($proyek_kerjasama->nama_proyek);$i++)
                                                                            ...
                                                                            <li>{{$proyek_kerjasama->nama_proyek[$i]}}</li>
                                                                            <li>{{$proyek_kerjasama->skema_investasi[$i]}}</li>
                                                                            <li>{{$proyek_kerjasama->nilai_investasi[$i]}}</li>
                                                                        <hr>
                                                                @endfor
                                                            @endforeach
                                                            @endisset
                                                        @elseif($row->field == 'proyek_investasi')
                                                            @php
                                                                $proyek_investasis = json_decode($data->proyek_investasi);
                                                            //dd($proyek_kerjasamas);
                                                            @endphp
                                                            @isset($proyek_investasis)
                                                                @foreach((array)$proyek_investasis as $proyek_investasi)
                                                                    ...
                                                                    @for($i=0;$i<count($proyek_investasi->nama_proyek);$i++)
                                                                            ...
                                                                            <li>{{$proyek_investasi->nama_proyek[$i]}}</li>
                                                                            <li>{{$proyek_investasi->nama_perusahaan[$i]}}</li>
                                                                            <li>{{$proyek_investasi->nilai_investasi[$i]}}</li>
                                                                        <hr>
                                                                    @endfor
                                                                @endforeach
                                                            @endisset
