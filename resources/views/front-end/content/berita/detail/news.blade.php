...
@endsection
@section('content')
    <div class="col-8 col-m-8 wow bounceIn" data-wow-delay=".5s">

        <div class="card post__card">
            <div class="post__header">
                <h4 class="post__title">{{$news->judul}}</h4>
            </div>
            ...
            <article class="post__content">
                {{--<div class="carousel">
                    <div class="slider carousel__slider--images">--}}
                        @php
                            $images = json_decode($news->gambar_berita)
                        @endphp
            ...
            <div class="post__bottom">
                ...
                <div class="post__socials">
                    <p class="post__social"><i class="mdi mdi-eye"></i> {{$news->getViewsCount()}} <span>views</span></p>
