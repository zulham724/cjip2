    ...
    <div class="col-8 col-m-8">
        ...
        <div class="card post__card">
            <div class="post__header">
                <div class="believe">
                    <img alt="{{$peternakan->userId->name}}" class="believe__avatar" style="float: left" src="{{Voyager::image($peternakan->userId->avatar)}}">
                </div>
                <h4 class="post__title">{{$peternakan->potensiId->jenis_komoditas}}</h4>
                <p class="post__category">{{$peternakan->userId->name}}</p>
            </div>
            ...
            <article class="post__content">
                <div class="carousel">
                    <div class="slider carousel__slider--images">
                        @php
                            $images = json_decode($peternakan->potensiId->foto)
                        @endphp
                        @foreach($images as $image)
                            <div class="carousel__slide">
                                <img src="{{Voyager::image($image)}}" alt="">
                                <p class="carousel__caption">{{$peternakan->lokasi}}</p>
                            </div>
                        @endforeach
                    </div>
                </div>
                <p>{!! $peternakan->keterangan!!} </p>
            </article>
            <div class="post__bottom">
                ...
                <div class="post__socials">
                    <p class="post__social"><i class="mdi mdi-eye"></i> {{$peternakan->getViewsCount()}} <span>views</span></p>
