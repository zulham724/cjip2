    ...
    <div class="col-8 col-m-8">
        ...
        <div class="card post__card">
            <div class="post__header">
                <div class="believe">
                    <img alt="{{$perikanan->userId->name}}" class="believe__avatar" style="float: left" src="{{Voyager::image($perikanan->userId->avatar)}}">
                </div>
                <h4 class="post__title">{{$perikanan->potensiId->jenis_komoditas}}</h4>
                <p class="post__category">{{$perikanan->userId->name}}</p>
            </div>
            ...
            <article class="post__content">
                <div class="carousel">
                    <div class="slider carousel__slider--images">
                        @php
                            $images = json_decode($perikanan->potensiId->foto)
                        @endphp
                        @foreach($images as $image)
                            <div class="carousel__slide">
                                <img src="{{Voyager::image($image)}}" alt="">
                                <p class="carousel__caption">{{$perikanan->lokasi}}</p>
                            </div>
                        @endforeach
                    </div>
                </div>
            ...
            <div class="post__bottom">
                ...
                <div class="post__socials">
                    <p class="post__social"><i class="mdi mdi-eye"></i> {{$perikanan->getViewsCount()}} <span>views</span></p>
