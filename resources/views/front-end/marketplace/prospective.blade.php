...
@section('header')
    <header id="headerEn" class="header-home">
        <div class="container background background--right background--header background--mobile"
             style="background-image: url({{Voyager::image(setting('site.bg_prospective'))}});">
            <div class="row">
                <div class="col-12">
                    <h2 class="header-home__title">{{Voyager::setting('site.title_prospective')}}</h2>
                    <p class="header-home__description">{{Voyager::setting('site.ket_prospective')}}</p>
                </div>
            </div>
        </div>
    </header>
    <header id="headerId" style="display: none;" class="header-home">
        <div class="container background background--right background--header background--mobile"
            ...
            <div class="row">
                <div class="col-12">
                    <h2 class="header-home__title">{{Voyager::setting('site.id_title_prospective')}}</h2>
                    <p class="header-home__description">{{Voyager::setting('site.id_ket_prospective')}}</p>
                </div>
            </div>
        </div>
    </header>
                            ...
                            <div class="col-6 about-app__description">
                                <div class="about-app__description-content">
                                    ...
                                    @endisset
                                        <div class="row">
                                            <div class="col-6">
                                                <a href="{{route('detail.pros', ['id'=>$proyek->id,'slug' => str_slug($proyek->project_name, '-')])}}" class="site-btn site-btn--accent header-home__btn">Project Detail</a>
                                            </div>
                                            <div class="col-6">
                            ...
                            <div class="col-6 about-app__description">
                                <div class="about-app__description-content">
                                    ...
                                    @endisset
                                        <div class="row">
                                            <div class="col-6">
                                                <a href="{{route('detail.pros', ['id'=>$proyek->id,'slug' => str_slug($proyek->project_name, '-')])}}" class="site-btn site-btn--accent header-home__btn">Detail Proyek</a>
                                            </div>
                                            <div class="col-6">
