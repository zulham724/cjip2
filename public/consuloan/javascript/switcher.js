...
$(document).ready(function() {
    var e = '<div class="switcher-container">' +
        ...
        '<a href="#" class="sw-pattern" data-image="/consuloan/images/pattern/1.png"><img src="/consuloan/images/pattern/1.png" alt="image"></a>' +
        '<a href="#" class="sw-pattern" data-image="/consuloan/images/pattern/2.png"><img src="/consuloan/images/pattern/2.png" alt="image"></a>' +
        '<a href="#" class="sw-pattern" data-image="/consuloan/images/pattern/3.png"><img src="/consuloan/images/pattern/3.png" alt="image"></a>' +
        '<a href="#" class="sw-pattern" data-image="/consuloan/images/pattern/4.png"><img src="/consuloan/images/pattern/4.png" alt="image"></a>' +
        '<a href="#" class="sw-pattern" data-image="/consuloan/images/pattern/5.png"><img src="/consuloan/images/pattern/5.png" alt="image"></a>' +
        '<a href="#" class="sw-pattern" data-image="/consuloan/images/pattern/6.png"><img src="/consuloan/images/pattern/6.png" alt="image"></a>' +
        '<a href="#" class="sw-pattern" data-image="/consuloan/images/pattern/7.png"><img src="/consuloan/images/pattern/7.png" alt="image"></a>' +
        '<a href="#" class="sw-pattern" data-image="/consuloan/images/pattern/8.png"><img src="/consuloan/images/pattern/8.png" alt="image"></a>' +
        '<a href="#" class="sw-pattern" data-image="/consuloan/images/pattern/9.png"><img src="/consuloan/images/pattern/9.png" alt="image"></a>' +
        '<a href="#" class="sw-pattern" data-image="/consuloan/images/pattern/10.png"><img src="/consuloan/images/pattern/10.png" alt="image"></a>' +
        '</div>' +
        '<div class="clearfix"></div>' +
        '</div>' +
        '</div>';
...
var switchColor = {
    ...
    setColor: function(e) {
        ...
        $(t.headLink).attr("href", "/consuloan/stylesheets/colors/" + e + ".css");
        $("#logo img").attr("src", "/images/logo-white.png");
        $("#logo-footer img").attr("src", "/images/logo-white.png");
