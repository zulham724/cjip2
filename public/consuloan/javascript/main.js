...
(function($) {
            ...
            $('.maps').gmap3({
                ...
                marker: {
                    ...
                    values: [{
                        ...
                        options: { icon: "/consuloan/images/maps/1.png" },
                                ...
                                $(this).gmap3({
                                    ...
                                    overlay: {
                                        ...
                                        options: {
                                            ...
                                            content: "<div class='infobox clearfix'><div class='img-map float-left'><img src='/consuloan/images/maps/f1.jpg' alt='image'></div><div class='info-map'><h5>40 Baria Sreet,<br> NewYork City, US</h5></div><div class='clearfix'></div></div>",
            ...
            $('.maps2').gmap3({
                ...
                marker: {
                    ...
                    values: [{
                        ...
                        options: { icon: "/consuloan/images/maps/2.png" },
    ...
    var retinaLogos = function() {
        ...
        if (retina) {
            ...
            $('.header .logo').find('img').attr({ src: '/images/logo-white.png', width: '217', height: '35' });
        ...
        if (retina) {
            ...
            $('.footer .logo').find('img').attr({ src: '/images/logo-white.png', width: '217', height: '35' });
