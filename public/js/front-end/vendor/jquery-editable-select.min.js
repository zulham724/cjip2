...
+function (a) {
    EditableSelect = function (b, c) {
        ...
        var b = 0, c = this.$input.val().toLowerCase().trim();
        ...
        if (this.$list.css({
            ...
            var b = {"default": "show", fade: "fadeIn", slide: "slideDown"}, c = b[this.options.effects];
        ...
        var b = {"default": "hide", fade: "fadeOut", slide: "slideUp"}, c = b[this.options.effects];
        ...
        var f = a("<li>").html(b), g = a("<option>").text(b), h = this.$list.find("li").length;
        ...
        b.es.$input.on("input keydown", function (a) {
            switch (a.keyCode) {
                case 38:
                    var c = b.es.$list.find("li.es-visible:not([disabled])"), d = c.index(c.filter("li.selected"));
        ...
        b.es.show(), setTimeout(function () {
            var c = b.es.$list.find("li.es-visible"), d = b.es.$list.find("li.selected").removeClass("selected"),
                e = c.index(d);
            if (c.length > 0) {
                var f = (c.length + a) % c.length, g = c.eq(f), h = g.position().top;
