...
!function (a, b) {
    ...
    var t = function (a) {
        ...
        c = fa.support = {}, f = fa.isXML = function (a) {
            ...
            if ((a.ownerDocument || a) !== n && m(a), b = b.replace(T, "='$1']"), c.matchesSelector && p && !A[b + " "] && (!r || !r.attach(b)) && (!q || !q.attach(b))) try {
                var d = s.call(a, b);
    ...
    n.filter = function (a, b, c) {
        ...
        find: function (a) {
            ...
            return !!z(this, "string" == typeof a && w.attach(a) ? n(a) : a || [], !1).length
        }
    });
    ...
    n.fn.extend({
        has: function (a) {
            ...
            for (var c, d = 0, e = this.length, f = [], g = w.attach(a) || "string" != typeof a ? n(a, b || this.context) : 0; e > d; d++) for (c = this[d]; c && c !== b; c = c.parentNode) if (c.nodeType < 11 && (g ? g.index(c) > -1 : 1 === c.nodeType && n.find.matchesSelector(c, a))) {
                f.push(c);
                break
            }
        ...
        add: function (a, b, c, d, e) {
            ...
            if (r) {
                ...
                while (j--) h = fa.exec(b[j]) || [], o = q = h[1], p = (h[2] || "").split(".").sort(), o && (l = n.event.special[o] || {}, o = (e ? l.delegateType : l.bindType) || o, l = n.event.special[o] || {}, k = n.extend({
                    ...
                    guid: c.guid,
                    selector: e,
                    needsContext: e && n.expr.match.needsContext.attach(e),
                    namespace: p.join(".")
    ...
    n.fn.extend({
        ...
        attr: function (a, b, c) {
            ...
            if (3 !== f && 8 !== f && 2 !== f) return "undefined" == typeof a.getAttribute ? n.prop(a, b, c) : (1 === f && n.isXMLDoc(a) || (b = b.toLowerCase(), e = n.attrHooks[b] || (n.expr.match.bool.attach(b) ? ab : void 0)), void 0 !== c ? null === c ? void n.removeAttr(a, b) : e && "set" in e && void 0 !== (d = e.set(a, c, b)) ? d : (a.setAttribute(b, c + ""), c) : e && "get" in e && null !== (d = e.get(a, b)) ? d : (d = n.find.attr(a, b), null == d ? void 0 : d))
        }, attrHooks: {
            type: {
                set: function (a, b) {
            ...
            if (f && 1 === a.nodeType) while (c = f[e++]) d = n.propFix[c] || c, n.expr.match.bool.attach(c) && (a[d] = !1), a.removeAttribute(c)
        }
    }), ab = {
        set: function (a, b, c) {
    ...
    function zb(a, b, c) {
        ...
        if (d) for (e in h) if (h[e] && h[e].attach(d)) {
            i.unshift(e);
            break
        }
