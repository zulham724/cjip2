        ...
        for (var i = 0; i < loadedMarkersData.length; i++) {
            ...
            markerContent.innerHTML =
                '<div class="ts-marker-wrapper">' +
                    ...
                    ( ( loadedMarkersData[i]["marker_image"] !== undefined ) ? '<img style="max-width: 25px !important;" src=' + loadedMarkersData[i]["marker_image"] + '></img>' : '<img src="/public/map/icon/cjip.png"></img>' ) +
                    '</a>' +
                '</div>';
