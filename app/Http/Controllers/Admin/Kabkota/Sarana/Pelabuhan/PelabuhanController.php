...
namespace App\Http\Controllers\Admin\Kabkota\Sarana\Pelabuhan;
...
class PelabuhanController extends Controller
{
    ...
    public function insertUpdateData($request, $slug, $rows, $data)
    {
        ...
        $sarpras = new SarprasAll();
        $sarpras->sarpras_id = $data->id;
        $sarpras->model_name = substr($slug, 0, -1);
        $sarpras->index = $data->nama_pelabuhan;
        $sarpras->city = $data->userId->name;
        $sarpras->status = $data->status;
        $sarpras->save();
