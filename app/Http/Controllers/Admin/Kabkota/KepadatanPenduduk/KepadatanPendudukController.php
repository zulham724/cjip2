...
namespace App\Http\Controllers\Admin\Kabkota\KepadatanPenduduk;
...
class KepadatanPendudukController extends BaseVoyagerBaseController
{
    ...
    public function create(Request $request)
    {
        ...
        $kecamatan = LuasWilayah::where('kab_kota_id', Auth::user()->id)->get();
        ...
        return Voyager::view($view, compact('dataType', 'dataTypeContent', 'isModelTranslatable', 'kecamatan'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $datanya = $request->address;
        $sumber = $request->sumber_data;
        //dd(count($datanya));
        //dd($all);
        ...
        foreach ($datanya as $item){
            $post = new KepadatanPenduduk();
            $post->kab_kota_id = $item['user'];
            $post->kecamatan_id = $item['kecamatan'];
            $post->lelaki = $item['pria'];
            $post->perempuan = $item['wanita'];
            $post->sumber_data = $sumber;
            $post->save();
        }
        $data=$post;
