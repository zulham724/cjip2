...
class ProyekController extends BaseVoyagerBaseController
{
    ...
    public function ckeditor(Request $request){
        if($request->hasFile('upload')) {
            ...
            //Upload File
            $request->file('upload')->storeAs('public/uploads/proyeks', $filenametostore);

            $CKEditorFuncNum = $request->input('CKEditorFuncNum');
            $url = asset('storage/uploads/proyeks/'.$filenametostore);
    ...
    public function insertUpdateData($request, $slug, $rows, $data)
    {
        ...
        $marketplace = $request->proyek_belongsto_jenis_marketplace_relationship;
        $profil = $request->proyek_belongsto_profil_kabupaten_relationship;
        $data->profil_id = $profil;
        $data->market_id = $marketplace;
        //dd($data);
        $data->save();
