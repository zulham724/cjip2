...
class UmkmFormController extends BaseVoyagerBaseController
{
    ...
    public function index(Request $request)
    {
        ...
        //dd(Auth::user()->hasRole('kab'));
        //dd(json_decode($dataTypeContent[0]->kbli));
        //dd(Auth::user()->namakota[0]->id);
        if (Auth::user()->hasRole('kab')){
        $dataTypeContent = $dataTypeContent->where('kab_kota_id', Auth::user()->namakota[0]->id);
        }
        else{
    ...
    public function show(Request $request, $id)
    {
        ...
        return Voyager::view($view, compact('dataType','kblis', 'dataTypeContent', 'isModelTranslatable', 'isSoftDeleted'));
    }
    ...
    public function edit(Request $request, $id)
    {
        ...
        return Voyager::view($view, compact('dataType', 'maps','kblis', 'dataTypeContent', 'isModelTranslatable'));
    }
    ...
    public function create(Request $request)
    {
        ...
        return Voyager::view($view, compact('dataType','kblis', 'dataTypeContent', 'maps', 'isModelTranslatable'));
    }
    ...
    public function insertUpdateData($request, $slug, $rows, $data)
    {
        ...
        foreach ($rows as $row) {
            ...
            if ($row->field == 'kbli') {
                $data->kbli = json_encode($request->kbli);
                //dd('test');
                /*continue;*/
            }
        ...
        $data->kbli = json_encode($request->kbli);
            ...
            $data->lat = $request->lat['lat'];
            $data->lng = $request->lat['lng'];
            $data->alamat = $request->input('alamat');
            $data->kecamatan = $request->input('kecamatan');
            $data->kelurahan = $request->input('kelurahan');
            $data->kab_kota_id = $request->kab_kota_id;

        if ($row->field = 'jumlah_investasi'){
            //dd($data->proyek_kerjasama);
            //dd($request->tambahans);
            //dd(array_sum($request->tambahans['nilai']));
            $nilai_investasi = array(
                'nilai_investasi' => $request->jumlah_investasi,
                'tahun' => Carbon::parse($request->tgl_terbit_oss)->format('Y')
            );
            $tambahan = array(
                'jenis' => null,
                'nilai_tambahan' => null,
            ...
            $data->investasi = json_encode($merge);
            //dd($data->proyek_kerjasama);
            //dd($data->tambahan);
        }
