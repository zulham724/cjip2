...
return [
    ...
    */
    ...
    'user' => [
        ...
        'redirect-gub'                  => '/admin/peta-potensi-investasi',
    ],
    ...
    */
    ...
    'googlemaps' => [
         'key'    => env('GOOGLE_MAPS_KEY', 'AIzaSyDKhYdxDaIq5d6-3lPAX9znKKJby6IPn6Q'),
         'center' => [
             'lat' => env('GOOGLE_MAPS_DEFAULT_CENTER_LAT', '-6.983306'),
             'lng' => env('GOOGLE_MAPS_DEFAULT_CENTER_LNG', '110.40764999999999'),
         ],
